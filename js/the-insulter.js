...
function insultDecider() {
	if (decider < 0.1) {
		...
		document.getElementById("insultOutput").innerHTML = name + " is so ugly, when your mom dropped you off at school she got a fine for littering.";	
	} else if (decider < 0.6) {
		document.getElementById("insultOutput").innerHTML = "The only way " + name + " will ever get laid is if you crawl up a chicken's ass and wait.";
	} else if (decider < 0.7) {
